...
# source licenses:
# utils_bak.py       The OpenLane Dataset Authors        Apache License, Version 2.0
#
...
def define_args():
    ...
    # Paths settings
    parser.add_argument('--dataset_dir',default='/workspace/openlane_all/lane3d_300/validation/', type=str, help='The path saving actual data')
    parser.add_argument('--pred_dir',default='./result/oft_work/work_dirs03/inferaf_dir01/json_file/', type=str, help='The path of prediction result')
    parser.add_argument('--test_list', default='./result/oft_work/work_dirs03/inferaf_dir01/infer_list.txt', type=str, help='The path of test list txt')
