...
from tools.evaluation.util_val.MinCostFlow import SolveMinCostFlow
from tools.evaluation.util_val.utils import *
...
class LaneEval(object):
    ...
    def show(self):
        ...
        dict_res = {'x_error_close': np.average(self.laneline_x_error_close),
...
if __name__ == '__main__':
    ...
    res_save_path = '/home/slj/Documents/workspace/ThomasVision/work_dirs_0426/vaild_json'
