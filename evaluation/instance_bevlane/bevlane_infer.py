...
def parse_args():
    ...
    parser.add_argument('--checkpoint', 
                        default='/workspace/lane/result/oft_work/work_dirs03/latest.pth')
    parser.add_argument('--show',
                        default=True,
                        help='show or false')
    parser.add_argument(
        '--show_dir', 
        default='./result/oft_work/work_dirs03/vis_img/', 
        help='directory where results will be saved')
    parser.add_argument('--out_path', 
                        default='./result/oft_work/work_dirs03/inferaf_dir01/', 
...
def main():
    ...
    for i, data_batch in tqdm(enumerate(data_loader), total=len(data_loader)):
        ...
        infer_list = []
        file_path = img_metas.data[0][0].get('file_path') # 文件路径            
        ...
        if args.show:
            ...
            img = vis_func.get_cam_imgs(imgs[0])
            ...
            heat_img = vis_func.get_pred_bev_feat(topdown[0])
