...
# This function duplicates functionality of mmcv.losses.iou_3d.nms_bev
# from mmcv<=1.5, but using cuda losses from mmcv.losses.nms.nms_rotated.
...
# This function duplicates functionality of mmcv.losses.iou_3d.nms_normal_bev
# from mmcv<=1.5, but using cuda losses from mmcv.losses.nms.nms.
# Nms api will be unified in mmdetection3d one day.
