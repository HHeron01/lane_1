...
from mmdet3d.sparsebit.utils.yaml_utils import _parse_config, update_config
from mmdet3d.sparsebit.quantization.common import *
...
_C.SCHEDULE = CN()
_C.SCHEDULE.FUSE_BN = True  # use ``with torch.no_grad()`` if it's enabled
