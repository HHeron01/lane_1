...
// #define STRIDE 4
#define N_OFFSETS 160 // if you use more than 73 offsets you will have to adjust this value
#define N_STRIPS (N_OFFSETS - 1)
#define PROP_SIZE (6 + N_OFFSETS)
#define DATASET_OFFSET 0

#define DIVUP(m,n) (((m)+(n)-1) / (n))
// int64_t const threadsPerBlock = sizeof(unsigned long long) * 8;
int64_t const threadsPerBlock = sizeof(unsigned long long) * 4;
